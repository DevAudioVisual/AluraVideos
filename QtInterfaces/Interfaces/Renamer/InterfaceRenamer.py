...
class Interface(cw.Widget):
        ...
        for arquivo_original, entrada_nome in self.entrada_videos.items():
            ...
            if novo_nome:
                ...
                novo_nome_arquivo = (self.campo_formato.text()
                                     ...
                                     .replace("-{sufixo}", f"-{self.campo_sufixo.text()}" if self.campo_sufixo.text() != "" else ""))
    ...
    def extrair_titulo_planilha(self,url_planilha):
        try:
    ...
    def buscar_na_planilha(self):
        ...
        if spreadsheet_url:
            self.campo_id.setText(self.extrair_titulo_planilha(spreadsheet_url))
